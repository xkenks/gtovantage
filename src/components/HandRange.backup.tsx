...
export interface HandInfo {
  action: 'RFI' | 'CALL' | '3BET' | 'FOLD' | 'MIXED' | 'MIN' | 'ALL_IN' | '3BB';
  frequency: number;
  // 混合戦略用の頻度分布
  mixedFrequencies?: {
    MIN: number;
...
export const btnOpenRaiseRange: Record<string, HandInfo> = {
  ...
  '44': { action: 'RFI', frequency: 100 },
  '33': { action: 'RFI', frequency: 100 },
  '22': { action: 'RFI', frequency: 100 },
  ...
  'A9s': { action: 'RFI', frequency: 100 },
  'A8s': { action: 'RFI', frequency: 100 },
  'A7s': { action: 'RFI', frequency: 100 },
  'A6s': { action: 'RFI', frequency: 100 },
  'A5s': { action: 'RFI', frequency: 100 },
  'A4s': { action: 'RFI', frequency: 100 },
  'A3s': { action: 'RFI', frequency: 100 },
  'A2s': { action: 'RFI', frequency: 100 },
  
  'AKo': { action: 'RFI', frequency: 100 },
  'AQo': { action: 'RFI', frequency: 100 },
  'AJo': { action: 'RFI', frequency: 100 },
  'ATo': { action: 'RFI', frequency: 100 },
  'A9o': { action: 'RFI', frequency: 100 },
  'A8o': { action: 'RFI', frequency: 100 },
  'A7o': { action: 'RFI', frequency: 100 },
  'A6o': { action: 'RFI', frequency: 100 },
  'A5o': { action: 'RFI', frequency: 100 },
  ...
  'KTs': { action: 'RFI', frequency: 100 },
  'K9s': { action: 'RFI', frequency: 100 },
  'K8s': { action: 'RFI', frequency: 100 },
  'K7s': { action: 'RFI', frequency: 100 },
  'K6s': { action: 'RFI', frequency: 100 },
  'K5s': { action: 'RFI', frequency: 100 },
  'K4s': { action: 'RFI', frequency: 100 },
  'K3s': { action: 'RFI', frequency: 100 },
  'K2s': { action: 'RFI', frequency: 100 },
  
  'KQo': { action: 'RFI', frequency: 100 },
  'KJo': { action: 'RFI', frequency: 100 },
  'KTo': { action: 'RFI', frequency: 100 },
  'K9o': { action: 'RFI', frequency: 100 },
  'K8o': { action: 'RFI', frequency: 100 },
  'K7o': { action: 'RFI', frequency: 100 },
  'K6o': { action: 'RFI', frequency: 100 },
  'K5o': { action: 'RFI', frequency: 100 },
  'K4o': { action: 'RFI', frequency: 100 },
  'K3o': { action: 'FOLD', frequency: 0 },
  'K2o': { action: 'FOLD', frequency: 0 },
  
  // 残り全てFOLD
  'QJs': { action: 'RFI', frequency: 100 },
  'QTs': { action: 'RFI', frequency: 100 },
  'Q9s': { action: 'RFI', frequency: 100 },
  'Q8s': { action: 'RFI', frequency: 100 },
  'Q7s': { action: 'RFI', frequency: 100 },
  'Q6s': { action: 'RFI', frequency: 100 },
  'Q5s': { action: 'RFI', frequency: 100 },
  'Q4s': { action: 'RFI', frequency: 100 },
  'Q3s': { action: 'RFI', frequency: 100 },
  'Q2s': { action: 'RFI', frequency: 100 },
  
  'QJo': { action: 'RFI', frequency: 100 },
  'QTo': { action: 'RFI', frequency: 100 },
  'Q9o': { action: 'RFI', frequency: 100 },
  'Q8o': { action: 'RFI', frequency: 100 },
  'Q7o': { action: 'RFI', frequency: 100 },
  'Q6o': { action: 'RFI', frequency: 100 },
  'Q5o': { action: 'RFI', frequency: 100 },
  'Q4o': { action: 'RFI', frequency: 100 },
  'Q3o': { action: 'FOLD', frequency: 0 },
  'Q2o': { action: 'FOLD', frequency: 0 },
  
  'JTs': { action: 'RFI', frequency: 100 },
  'J9s': { action: 'RFI', frequency: 100 },
  'J8s': { action: 'RFI', frequency: 100 },
  'J7s': { action: 'RFI', frequency: 100 },
  'J6s': { action: 'RFI', frequency: 100 },
  'J5s': { action: 'RFI', frequency: 100 },
  'J4s': { action: 'RFI', frequency: 100 },
  'J3s': { action: 'RFI', frequency: 100 },
  'J2s': { action: 'RFI', frequency: 100 },
  
  'JTo': { action: 'RFI', frequency: 100 },
  'J9o': { action: 'RFI', frequency: 100 },
  'J8o': { action: 'RFI', frequency: 100 },
  'J7o': { action: 'RFI', frequency: 100 },
  'J6o': { action: 'RFI', frequency: 100 },
  'J5o': { action: 'RFI', frequency: 100 },
  'J4o': { action: 'FOLD', frequency: 0 },
  'J3o': { action: 'FOLD', frequency: 0 },
  'J2o': { action: 'FOLD', frequency: 0 },
  
  'T9s': { action: 'RFI', frequency: 100 },
  'T8s': { action: 'RFI', frequency: 100 },
  'T7s': { action: 'RFI', frequency: 100 },
  'T6s': { action: 'RFI', frequency: 100 },
  'T5s': { action: 'RFI', frequency: 100 },
  'T4s': { action: 'RFI', frequency: 100 },
  'T3s': { action: 'RFI', frequency: 100 },
  'T2s': { action: 'RFI', frequency: 100 },
  
  'T9o': { action: 'RFI', frequency: 100 },
...
export const MTTRangeEditor: React.FC<{
  ...
  const getHandFrequencies = (hand: string) => {
    ...
    if (handInfo?.mixedFrequencies) {
      return handInfo.mixedFrequencies;
    }
  ...
  const getHandBackgroundStyle = (hand: string) => {
    ...
    if (totalNonFold === 100 && frequencies.FOLD === 0) {
      // 単一アクション100%
      const action = Object.entries(frequencies).find(([_, freq]) => freq === 100)?.[0];
      if (action && action !== 'FOLD') {
        const color = getActionColorHex(action);
        return {
          background: color,
    ...
    if (totalNonFold > 0) {
      ...
      if (frequencies.FOLD > 0) {
        gradientStops.push(`rgba(31, 41, 55, 0.3) ${currentPosition}% 100%`);
      }
  ...
  const getHandDisplayText = (hand: string) => {
    const frequencies = getHandFrequencies(hand);
    const activeActions = [
      { name: 'MIN', freq: frequencies.MIN, symbol: 'M' },
      { name: 'ALL_IN', freq: frequencies.ALL_IN, symbol: 'A' },
      { name: 'CALL', freq: frequencies.CALL, symbol: 'C' },
      { name: 'FOLD', freq: frequencies.FOLD, symbol: 'F' }
    ...
    if (activeActions.length === 1 && activeActions[0].freq === 100) {
      ...
      return (
        <div className="text-center">
          <div className="text-xs font-bold leading-tight">{hand}</div>
          <div className="text-[7px] leading-none space-y-0">
            {topTwo.map((action) => (
              <div key={action.name} className="text-white font-semibold">
  ...
  const getStats = () => {
    ...
    grid.flat().forEach(cell => {
      ...
      actions.MIN += frequencies.MIN / 100;
      actions.ALL_IN += frequencies.ALL_IN / 100;
      actions.CALL += frequencies.CALL / 100;
      actions.FOLD += frequencies.FOLD / 100;
    });
      ...
      <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl p-6 max-w-6xl w-full mx-4 max-h-[95vh] overflow-y-auto shadow-2xl border border-gray-700">
        ...
        <div className="mt-4 bg-gray-800 rounded-lg p-3 border border-gray-600">
          ...
          <ul className="text-xs text-gray-400 space-y-1">
            ...
            <li>• 混合戦略のハンドは境界線の色と小さな%表示で識別</li>
